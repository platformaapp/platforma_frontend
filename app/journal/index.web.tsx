...
const styles = StyleSheet.create({
  ...
  cardCategory: { fontSize: 12, fontFamily: 'Inter-Regular', color: '#687076', marginBottom: 6 },
  cardTitleText: { fontSize: 16, lineHeight: 22, fontFamily: 'Inter-Medium', color: '#181818' },
  ...
  mobileTitleText: { fontSize: 14, lineHeight: 18, fontFamily: 'Inter-Medium', color: '#181818' },
});
