...
const styles = StyleSheet.create({
  ...
  btnText: { fontFamily: 'Gramatika-Regular', fontSize: 14, fontWeight: '400', lineHeight: 20 },
  btnPrimaryText: { color: '#FFF' },
  btnOutlineText: { color: '#181818' },
  bottomLinks: { alignItems: 'center', gap: 16, paddingHorizontal: 16 },
  linkText: { textAlign: 'center', fontFamily: 'Gramatika-Regular', fontSize: 14, lineHeight: 20, color: '#181818' },
});
