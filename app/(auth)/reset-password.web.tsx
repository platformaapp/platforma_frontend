...
const styles = StyleSheet.create({
  ...
  errorText: { fontFamily: 'Inter-Regular', fontSize: 13, color: '#E02D2D', marginTop: 4, marginBottom: 8 },
  hint: { fontFamily: 'Inter-Regular', fontSize: 12, lineHeight: 16, color: '#9B9B9B', marginTop: 4 },
