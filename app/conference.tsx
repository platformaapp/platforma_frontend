...
const styles = StyleSheet.create({
  ...
  webChooserTitle: { fontSize: 20, fontFamily: 'Gramatika-Regular', fontWeight: 'normal', color: '#181818', textAlign: 'center', marginBottom: 8 },
  ...
  webChooserButtonPrimaryText: { color: '#fff', fontSize: 16, fontFamily: 'Gramatika-Regular', fontWeight: 'normal' },
  webChooserButtonSecondary: { borderWidth: 1, borderColor: '#CFCFCF', paddingVertical: 16, alignItems: 'center', justifyContent: 'center' },
  webChooserButtonSecondaryText: { color: '#181818', fontSize: 16, fontFamily: 'Gramatika-Regular', fontWeight: 'normal' },
});
