    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.section, styles.lastSection]}>
          ...
          {[
            ['Оператор платформы', 'ИП Якунин Владислав Александрович'],
            ['ИНН', '344214640369'],
            ['ОГРНИП', '326344300061998'],
            ['Юридический адрес', '400007, Россия, Волгоградская обл., г. Волгоград, ул. Таращанцев, д. 8, кв. 1'],
            ['Email', 'v.yakunin2011@yandex.ru'],
            ['Расчётный счёт', '40802810000009675691'],
            ['Банк', 'АО «ТБанк»'],
            ['БИК банка', '044525974'],
            ['Корр. счёт банка', '30101810145250000974'],
          ].map(([label, value], i) => (
...
const styles = StyleSheet.create({
  ...
  mainTitle: {
    fontSize: 20, lineHeight: 28, fontFamily: 'Gramatika-Regular', color: '#181818',
    marginBottom: 12, marginTop: 8,
  },
  intro: {
    fontSize: 14, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#555',
    marginBottom: 10,
  },
  section: { marginTop: 20, marginBottom: 8 },
  lastSection: { marginBottom: 0 },
  sectionHeading: {
    fontSize: 16, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#181818',
  ...
  stepNumText: { fontSize: 12, fontFamily: 'Gramatika-Regular', color: '#fff' },
  stepText: { fontSize: 14, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#181818', flex: 1 },
  body: { fontSize: 14, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#181818', marginBottom: 8 },
  bodyLabel: { fontSize: 14, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#181818', marginBottom: 6, marginTop: 4 },
  legalLinks: { gap: 8, marginTop: 4 },
  legalLink: { fontSize: 14, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#181818', textDecorationLine: 'underline' },
  bulletItem: { fontSize: 14, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#181818', marginBottom: 4, paddingLeft: 4 },
  contactRow: { flexDirection: 'row', marginBottom: 8, flexWrap: 'wrap' },
  contactLabel: { fontSize: 13, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#555', marginRight: 6, minWidth: 120 },
  contactValue: { fontSize: 13, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818', flex: 1 },
});
