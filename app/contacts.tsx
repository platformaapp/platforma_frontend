...
const styles = StyleSheet.create({
  ...
  mainTitle: { fontSize: 22, lineHeight: 28, fontFamily: 'Gramatika-Regular', fontWeight: 'bold', color: '#181818', marginTop: 4, marginBottom: 16 },
  email: { fontSize: 15, lineHeight: 22, fontFamily: 'Gramatika-Regular', fontWeight: 'bold', color: '#181818', textDecorationLine: 'underline', marginBottom: 28 },
