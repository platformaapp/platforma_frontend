...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 16, fontFamily: 'Gramatika-Regular', fontWeight: '700', color: '#181818', marginBottom: 6 },
  ...
  input: { flex: 1, paddingHorizontal: 12, paddingVertical: 14, fontSize: 16, fontFamily: 'Gramatika-Regular', color: '#181818' },
  inputSuffix: { width: 44, borderLeftWidth: 1, borderColor: '#1E1E1E', alignItems: 'center', justifyContent: 'center' },
  inputSuffixText: { fontSize: 16, fontFamily: 'Gramatika-Regular', color: '#181818' },
  ...
  infoTitle: { fontSize: 14, fontFamily: 'Gramatika-Regular', fontWeight: '600', color: '#181818', marginBottom: 6 },
  infoText: { fontSize: 13, fontFamily: 'Gramatika-Regular', color: '#555', lineHeight: 18, marginBottom: 14 },
  usersBtn: { borderWidth: 1, borderColor: '#1E1E1E', height: 44, alignItems: 'center', justifyContent: 'center' },
  usersBtnText: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#181818' },
