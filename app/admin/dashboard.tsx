...
const styles = StyleSheet.create({
  ...
  logoutText: { fontSize: 13, fontFamily: 'Gramatika-Regular', color: '#181818' },
  ...
  navBtnText: { fontSize: 11, fontFamily: 'Gramatika-Regular', color: '#181818', letterSpacing: 0.2 },
  ...
  tabText: { fontSize: 12, fontFamily: 'Gramatika-Regular', color: '#181818', letterSpacing: 0.3 },
  ...
  avatarInitial: { fontSize: 20, fontFamily: 'Gramatika-Regular', color: '#9B9B9B' },
  cardBody: { flex: 1, paddingVertical: 10, paddingRight: 8 },
  cardName: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', fontWeight: '600', color: '#181818', marginBottom: 2 },
  cardEmail: { fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', marginBottom: 2 },
  cardMeta: { fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#555', marginBottom: 4 },
  cardFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 4 },
  cardDate: { fontSize: 11, fontFamily: 'Gramatika-Regular', color: '#9B9B9B' },
  ...
  approveBtnText: { fontSize: 16, color: '#155724', fontFamily: 'Gramatika-Regular' },
  rejectBtnText: { fontSize: 16, color: '#721c24', fontFamily: 'Gramatika-Regular' },
  ...
  detailName: { fontSize: 18, lineHeight: 24, fontFamily: 'Gramatika-Regular', fontWeight: '700', color: '#181818' },
  ...
  detailCloseBtnText: { fontSize: 15, fontFamily: 'Gramatika-Regular', color: '#181818' },
  btnDisabled: { opacity: 0.5 },
  actionErrorText: { fontSize: 13, fontFamily: 'Gramatika-Regular', color: '#E02D2D', marginBottom: 10 },

  rejectModalTitle: { fontSize: 22, fontFamily: 'Gramatika-Regular', fontWeight: '700', color: '#181818', marginBottom: 4 },
  rejectModalSubtitle: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', marginBottom: 14 },
  rejectInput: {
