...
const styles = StyleSheet.create({
  ...
  cardName: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', fontWeight: 'normal', color: '#181818', marginBottom: 2 },
  ...
  rejectModalTitle: { fontSize: 22, fontFamily: 'Gramatika-Regular', fontWeight: 'normal', color: '#181818', marginBottom: 4 },
