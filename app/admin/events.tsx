...
const styles = StyleSheet.create({
  ...
  cardMeta: { fontSize: 11, lineHeight: 15, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', marginBottom: 2 },
  cardDate: { fontSize: 11, lineHeight: 15, fontFamily: 'Gramatika-Regular', color: '#555', marginBottom: 4 },
  ...
  priceBadge: { fontSize: 11, fontFamily: 'Gramatika-Regular', color: '#181818', backgroundColor: '#E5E5E5', paddingHorizontal: 6, paddingVertical: 2 },
  ...
  blockBtnText: { fontSize: 10, fontFamily: 'Gramatika-Regular', textAlign: 'center' },
  ...
  modalSubtitle: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', marginBottom: 10 },
  modalNote: { fontSize: 13, fontFamily: 'Gramatika-Regular', color: '#555', marginBottom: 12 },
