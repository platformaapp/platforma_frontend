...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontFamily: 'Gramatika-Regular', fontWeight: '700', color: '#181818' },
  searchRow: { paddingHorizontal: 16, paddingVertical: 10, borderBottomWidth: 1, borderColor: '#E5E5E5' },
  searchInput: { borderWidth: 1, borderColor: '#1E1E1E', paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#181818' },
  ...
  avatarInitial: { fontSize: 18, fontFamily: 'Gramatika-Regular', color: '#9B9B9B' },
  cardBody: { flex: 1, paddingVertical: 8, paddingRight: 4 },
  cardName: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', fontWeight: '600', color: '#181818', marginBottom: 1 },
  cardEmail: { fontSize: 11, lineHeight: 15, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', marginBottom: 2 },
  cardMeta: { fontSize: 11, lineHeight: 15, fontFamily: 'Gramatika-Regular', color: '#555', marginBottom: 4 },
  cardFooter: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  statusBadge: { paddingHorizontal: 7, paddingVertical: 2 },
  statusText: { fontSize: 11, fontFamily: 'Gramatika-Regular', fontWeight: '600' },
  commissionBadge: { fontSize: 11, fontFamily: 'Gramatika-Regular', color: '#181818', backgroundColor: '#E5E5E5', paddingHorizontal: 6, paddingVertical: 2 },
  ...
  actionBtnText: { fontSize: 10, fontFamily: 'Gramatika-Regular', textAlign: 'center' },
  commissionBtnText: { fontSize: 15, fontFamily: 'Gramatika-Regular', color: '#181818' },
  errorText: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#E02D2D', textAlign: 'center', marginBottom: 12 },
  retryBtn: { borderWidth: 1, borderColor: '#181818', paddingVertical: 10, paddingHorizontal: 24 },
  retryText: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#181818' },
  emptyText: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#9B9B9B' },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.45)', justifyContent: 'flex-end' },
  modalSheet: { backgroundColor: '#fff', paddingHorizontal: 16, paddingTop: 20, paddingBottom: 32 },
  modalTitle: { fontSize: 22, fontFamily: 'Gramatika-Regular', fontWeight: '700', color: '#181818', marginBottom: 4 },
  modalSubtitle: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', marginBottom: 12 },
  modalWarning: { fontSize: 13, fontFamily: 'Gramatika-Regular', color: '#856404', backgroundColor: '#FFF3CD', paddingHorizontal: 12, paddingVertical: 10, marginBottom: 12 },
  actionError: { fontSize: 13, fontFamily: 'Gramatika-Regular', color: '#E02D2D', marginBottom: 10 },
  ...
  confirmBtnText: { fontSize: 15, fontFamily: 'Gramatika-Regular' },
  cancelBtn: { height: 48, borderWidth: 1, borderColor: '#1E1E1E', alignItems: 'center', justifyContent: 'center' },
  cancelBtnText: { fontSize: 15, fontFamily: 'Gramatika-Regular', color: '#181818' },
  btnDisabled: { opacity: 0.5 },
  commissionLabel: { fontSize: 13, fontFamily: 'Gramatika-Regular', color: '#555', marginBottom: 8 },
  commissionInput: { borderWidth: 1, borderColor: '#1E1E1E', paddingHorizontal: 12, paddingVertical: 12, fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#181818', marginBottom: 8 },
});
