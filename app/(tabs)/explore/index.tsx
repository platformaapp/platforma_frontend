...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 16, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#181818', marginBottom: 2 },
  shortBio: { fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#181818' },
  bioSection: {
  ...
  bioText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  priceRow: {
    flexDirection: 'row',
  ...
  priceLabel: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  priceValue: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  contactButton: { backgroundColor: '#111', paddingVertical: 14, alignItems: 'center' },
  contactButtonSecondary: { backgroundColor: '#fff' },
  contactButtonText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#FFFFFF' },
  contactButtonSecondaryText: { color: '#181818' },
  errorText: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#E02D2D', textAlign: 'center' },
  emptyText: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', textAlign: 'center' },
});
