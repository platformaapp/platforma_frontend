...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 18, lineHeight: 24, fontFamily: 'Gramatika-Regular', color: '#181818', marginBottom: 4 },
  roleText: { fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#181818' },

  bioSection: { paddingHorizontal: 16, paddingVertical: 14, borderTopWidth: 1, borderColor: '#1E1E1E' },
  bioText: { fontSize: 13, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },

  priceRow: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
    paddingHorizontal: 16, paddingVertical: 12, borderTopWidth: 1, borderColor: '#1E1E1E',
  },
  priceLabel: { fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#181818' },
  priceValue: { fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#181818' },
  ...
  tutorBlockedText: { fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', textAlign: 'center' },
  ...
  shareText: { flex: 1, paddingLeft: 16, fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  ...
  sheetSecondaryButtonText: { fontSize: 16, fontFamily: 'Gramatika-Regular', color: '#181818' },

  // Slot grid
  slotsCentered: { height: 120, alignItems: 'center', justifyContent: 'center' },
  slotsErrorText: { fontSize: 13, fontFamily: 'Gramatika-Regular', color: '#E02D2D', textAlign: 'center' },
  slotsEmptyText: { fontSize: 13, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', textAlign: 'center' },
  ...
  slotDate: { fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#181818', textAlign: 'center' },
  slotTime: { fontSize: 11, lineHeight: 14, fontFamily: 'Gramatika-Regular', color: '#181818', textAlign: 'center', marginTop: 2 },
  ...
  bookingCardName: { fontSize: 16, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#1E1E1E' },
  bookingCardBottom: { flexDirection: 'row', alignItems: 'center', minHeight: 46 },
  bookingCardDateTime: { flex: 1, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#1E1E1E' },
  bookingCardDivider: { width: 1, alignSelf: 'stretch', backgroundColor: '#1E1E1E' },
  bookingCardPrice: { flex: 1, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#1E1E1E', textAlign: 'right' },

  // Share popup
  shareCard: { borderWidth: 1, borderColor: '#1E1E1E', backgroundColor: '#FFFFFF' },
  shareUrl: { paddingHorizontal: 16, paddingVertical: 16, fontSize: 16, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#1E1E1E' },
  ...
  payErrorText: { paddingHorizontal: 16, paddingVertical: 16, fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#E02D2D' },
  legalText: { fontSize: 12, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', textAlign: 'center', marginTop: 12 },
