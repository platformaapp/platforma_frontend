...
const styles = StyleSheet.create({
  ...
  cancelModalTitle: { fontSize: 22, lineHeight: 28, fontFamily: 'Gramatika-Regular', fontWeight: '700', color: '#181818', textTransform: 'uppercase', letterSpacing: -0.5, marginBottom: 12 },
