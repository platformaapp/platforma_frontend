        ...
        <Pressable style={styles.modalOverlay} onPress={() => { setCancelBookingSuccessVisible(false); setCancelBookingTarget(null); }}>
          <Pressable style={styles.modalSheet} onPress={() => {}}>
            ...
            {(!cancelBookingTarget?.date || new Date(`${cancelBookingTarget.date}T${cancelBookingTarget.time ?? '23:59'}:00`).getTime() - Date.now() >= 24 * 60 * 60 * 1000) && (
              <Text style={styles.cancelModalSubtext}>Деньги вернутся на карту в течении 3 рабочих дней или даже быстрее</Text>
            )}
...
const styles = StyleSheet.create({
  ...
  tabText: { fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#181818', letterSpacing: 0.5 },
  ...
  cardTitle: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  eventStatus: { marginTop: 4, fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#9B9B9B' },
  bookingStatus: { marginTop: 4, fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#9B9B9B' },
  cardPrice: { marginTop: 4, fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#181818' },
  cardBottom: { flexDirection: 'row', alignItems: 'center', minHeight: 44 },
  cardAuthor: { flex: 1, paddingHorizontal: 12, fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  cardDate: { fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#181818', paddingRight: 4 },
  cardMenu: { width: 44, borderLeftWidth: 1, borderColor: '#1E1E1E', alignItems: 'center', justifyContent: 'center', alignSelf: 'stretch' },
  cardMenuText: { fontSize: 18, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  ...
  emptySheetTitle: { fontSize: 22, lineHeight: 28, fontFamily: 'Gramatika-Regular', color: '#FFFFFF', marginBottom: 8 },
  emptySheetDescription: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: 'rgba(255,255,255,0.7)', marginBottom: 24 },
  emptySheetButton: { borderWidth: 1, borderColor: 'rgba(255,255,255,0.4)', height: 52, alignItems: 'center', justifyContent: 'center' },
  emptySheetButtonText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#FFFFFF' },
  ...
  modalEventTitle: { fontSize: 16, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#1E1E1E', marginBottom: 12 },
  modalEventDate: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#1E1E1E' },
  ...
  modalActionButtonText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  ...
  modalCancelButtonText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#E02D2D' },
  disabledButton: { opacity: 0.5 },
  cancelModalTitle: { fontSize: 22, lineHeight: 28, fontFamily: 'Gramatika-Regular', fontWeight: 'normal', color: '#181818', textTransform: 'uppercase', letterSpacing: -0.5, marginBottom: 12 },
  cancelModalSubtext: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', marginBottom: 20 },
  cancelModalWarning: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#E02D2D', marginBottom: 20 },
  cancelModalKeepButton: { height: 52, borderWidth: 1, borderColor: '#1E1E1E', alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  cancelModalKeepText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  cancelModalConfirmButton: { height: 52, backgroundColor: '#E02D2D', alignItems: 'center', justifyContent: 'center' },
  cancelModalConfirmText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#FFFFFF' },
  ...
  roleGroupHeader: { fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', fontWeight: 'normal', color: '#181818', marginHorizontal: 16, marginTop: 16, marginBottom: 8 },
  ...
  videoButtonText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#FFFFFF' },
  ...
  countdownBarText: { flex: 1, fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#FFFFFF' },
  countdownBarHint: { fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#AAAAAA' },
  countdownBarButton: { marginTop: 8, borderWidth: 1, borderColor: '#FFFFFF', height: 44, alignItems: 'center', justifyContent: 'center' },
  countdownBarButtonText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#FFFFFF' },
  participantCount: { marginTop: 4, fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#9B9B9B' },
});
