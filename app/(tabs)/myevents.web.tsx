...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontFamily: 'Gramatika-Bold', color: '#010101' },
  ...
  headerVideoButtonText: { fontFamily: 'Gramatika-Bold', fontSize: 14, color: '#fff' },
  ...
  tabText: { fontFamily: 'Gramatika-Regular', fontSize: 16, color: '#9B9B9B' },
  ...
  emptyTitle: { fontSize: 20, fontFamily: 'Gramatika-Bold', color: '#010101', flex: 1 },
  ...
  emptyLink: { fontFamily: 'Gramatika-Bold', fontSize: 14, color: '#E02D2D', alignSelf: 'flex-end' },
  groupHeader: { fontSize: 16, fontFamily: 'Gramatika-Bold', color: '#010101', marginTop: 8, marginBottom: 12 },
  pastSeparator: { fontSize: 22, fontFamily: 'Gramatika-Bold', color: '#010101', marginTop: 32, marginBottom: 16 },
  ...
  cardTitle: { fontSize: 16, lineHeight: 22, fontFamily: 'Gramatika-Bold', color: '#010101', marginBottom: 8 },
  ...
  listTitle: { fontSize: 14, lineHeight: 19, fontFamily: 'Gramatika-Bold', color: '#010101' },
  ...
  menuButtonText: { fontSize: 16, color: '#010101', fontFamily: 'Gramatika-Bold', letterSpacing: 1, marginTop: -8 },
  ...
  mobileVideoBarButtonText: { fontFamily: 'Gramatika-Bold', fontSize: 13, color: '#010101' },
  ...
  confirmTitle: { fontFamily: 'Gramatika-Bold', fontSize: 18, lineHeight: 24, color: '#010101', textTransform: 'uppercase', marginBottom: 12 },
  ...
  confirmBtnOutlineText: { fontFamily: 'Gramatika-Bold', fontSize: 14, color: '#010101' },
  confirmBtnDanger: { backgroundColor: '#E02D2D', paddingVertical: 12, alignItems: 'center', justifyContent: 'center' },
  confirmBtnDangerText: { fontFamily: 'Gramatika-Bold', fontSize: 14, color: '#fff' },
  confirmBtnDark: { backgroundColor: '#010101', paddingVertical: 12, alignItems: 'center', justifyContent: 'center' },
  confirmBtnDarkText: { fontFamily: 'Gramatika-Bold', fontSize: 14, color: '#fff' },
  ...
  modalTitle: { fontFamily: 'Gramatika-Bold', fontSize: 20, color: '#010101' },
  ...
  modalSaveText: { fontFamily: 'Gramatika-Bold', fontSize: 15, color: '#E02D2D' },
});
