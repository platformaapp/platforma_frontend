...
const styles = StyleSheet.create({
  ...
  aboutLink: {
    fontSize: 13, lineHeight: 26, fontFamily: 'Gramatika-Regular', color: '#181818',
    textDecorationLine: 'underline',
  },
  errorText: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#E02D2D', textAlign: 'center', marginBottom: 16, paddingHorizontal: 24 },
  retryButton: { borderWidth: 1, borderColor: '#181818', paddingVertical: 10, paddingHorizontal: 32 },
  retryButtonText: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#181818' },
  ...
  cardTitleText: { fontSize: 16, lineHeight: 22, fontFamily: 'Gramatika-Regular', color: '#181818', marginBottom: 6 },
  description: { fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#181818' },
  footer: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'stretch',
    borderTopWidth: 1, borderColor: '#1E1E1E',
  },
  footerTime: {
    fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#FFFFFF',
  ...
  footerPrice: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#1E1E1E' },
});
