...
const styles = StyleSheet.create({
  ...
  roleButtonText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  ...
  studentInviteText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  ...
  profileName: { fontSize: 18, lineHeight: 24, fontFamily: 'Gramatika-Regular', color: '#181818', marginBottom: 4 },
  profileRole: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  profileRate: { fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#9B9B9B', marginTop: 4 },
  ...
  actionText: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  actionPrimary: { backgroundColor: '#111' },
  actionPrimaryText: { color: '#FAFAFA' },
  sectionTitle: { fontSize: 20, lineHeight: 28, fontFamily: 'Gramatika-Regular', color: '#181818', marginBottom: 12 },
  ...
  slotText: { fontSize: 14, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#181818', textAlign: 'center' },
  ...
  inviteTitle: { fontSize: 18, lineHeight: 24, fontFamily: 'Gramatika-Regular', color: '#181818', marginBottom: 4 },
  inviteSubtitle: { fontSize: 14, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#181818' },
  ...
  shareModalButtonText: { fontSize: 16, fontFamily: 'Gramatika-Regular', color: '#fff' },
  ...
  becomeTutorSubtitle: { fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#9B9B9B' },
  ...
  tutorRegInfoText: { fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#9B9B9B' },
  tutorRegInput: { borderWidth: 1, borderColor: '#1E1E1E', paddingVertical: 14, paddingHorizontal: 12, marginBottom: 4, fontFamily: 'Gramatika-Regular', fontSize: 14, color: '#181818' },
  tutorRegInputError: { borderColor: '#E02D2D', color: '#E02D2D' },
  tutorRegErrorText: { fontFamily: 'Gramatika-Regular', fontSize: 12, color: '#E02D2D', marginBottom: 6 },
  appStatusBanner: { backgroundColor: '#FFF3CD', paddingHorizontal: 14, paddingVertical: 12, marginBottom: 16 },
  appStatusBannerText: { fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#856404' },
});
