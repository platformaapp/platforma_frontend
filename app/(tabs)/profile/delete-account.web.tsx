...
const styles = StyleSheet.create({
  ...
  description: { fontFamily: 'Gramatika-Regular', fontSize: 14, lineHeight: 20, color: '#687076', marginBottom: 20 },
  ...
  deleteLink: { fontFamily: 'Gramatika-Bold', fontSize: 15, color: '#E02D2D' },
});
