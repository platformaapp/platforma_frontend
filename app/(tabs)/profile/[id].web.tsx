...
const styles = StyleSheet.create({
  ...
  studentName: { fontSize: 40, lineHeight: 36, fontFamily: 'Gramatika-Bold', color: '#010101' },
  ...
  modalTitle: { fontSize: 25, lineHeight: 23, fontFamily: 'Gramatika-Bold', color: '#010101', marginBottom: 20 },
  ...
  balanceLabel: { fontSize: 30, fontFamily: 'Gramatika-Bold', color: '#010101' },
  ...
  sectionTitle: { fontSize: 25, lineHeight: 23, fontFamily: 'Gramatika-Bold', color: '#010101', marginTop: 24, marginBottom: 8 },
