...
const styles = StyleSheet.create({
  ...
  linkRow: { flexDirection: 'row', borderWidth: 1, borderColor: '#010101', height: 56, marginBottom: 8 },
  linkRowDisabled: { borderWidth: 1, borderColor: '#E5E5E5', height: 56, justifyContent: 'center', paddingHorizontal: 16, marginBottom: 8 },
  linkTextDisabled: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#9B9B9B' },
  ...
  legalText: { marginTop: 4, fontSize: 12, lineHeight: 16, fontFamily: 'Gramatika-Regular', color: '#9B9B9B' },
  ...
  historyNumber: { fontSize: 13, fontFamily: 'Gramatika-Bold', color: '#010101' },
  ...
  historyTitle: { fontSize: 14, fontFamily: 'Gramatika-Regular', color: '#010101', marginBottom: 2 },
  ...
  historyAmount: { fontSize: 14, fontFamily: 'Gramatika-Bold', color: '#010101' },
