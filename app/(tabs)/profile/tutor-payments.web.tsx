...
const styles = StyleSheet.create({
  ...
  balanceRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderWidth: 1, borderColor: '#181818', paddingHorizontal: 16, paddingVertical: 16, marginBottom: 4 },
  balanceLabel: { fontSize: 14, fontFamily: 'Inter-Regular', color: '#181818' },
  balanceRight: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  balanceAmount: { fontSize: 16, fontFamily: 'Inter-Bold', color: '#181818' },
  infoIcon: { padding: 4 },
  infoIconText: { fontSize: 14, color: '#9B9B9B' },
  tooltipText: { fontSize: 12, lineHeight: 16, fontFamily: 'Inter-Regular', color: '#687076', marginBottom: 16 },
  tooltipTextRight: { fontSize: 11, lineHeight: 14, fontFamily: 'Inter-Regular', color: '#687076', marginTop: 4, maxWidth: 160, textAlign: 'right' },

  cardBlock: { borderWidth: 1, borderColor: '#181818', marginBottom: 24 },
  ...
  linkCardRow: { flexDirection: 'row', borderWidth: 1, borderColor: '#181818', height: 56, marginBottom: 24 },
  ...
  sectionTitle: { fontSize: 13, fontFamily: 'Inter-Regular', color: '#9B9B9B', marginBottom: 12, marginTop: 8 },
  ...
  historyLeft: { flex: 1 },
  historyId: { fontSize: 13, fontFamily: 'Inter-Medium', color: '#181818' },
  historyDesc: { fontSize: 14, fontFamily: 'Inter-Regular', color: '#181818', marginTop: 4 },
  historyDate: { fontSize: 12, fontFamily: 'Inter-Regular', color: '#9B9B9B', marginTop: 4 },
  historyRight: { alignItems: 'flex-end' },
  historyStatusRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  historyStatus: { fontSize: 12, fontFamily: 'Inter-Regular', color: '#181818' },
  historyAmount: { fontSize: 14, fontFamily: 'Inter-Medium', color: '#181818', marginTop: 4 },
  emptyText: { fontSize: 14, fontFamily: 'Inter-Regular', color: '#9B9B9B', marginTop: 8 },
  ...
  modalTitle: { fontSize: 18, fontFamily: 'Inter-Bold', color: '#181818', marginBottom: 12, textTransform: 'uppercase', lineHeight: 24 },
  modalTitleDanger: { color: '#E02D2D' },
  modalMessage: { fontSize: 14, lineHeight: 20, fontFamily: 'Inter-Regular', color: '#181818', marginBottom: 8 },
  modalMessageDanger: { color: '#E02D2D' },
  modalEventCard: { borderWidth: 1, borderColor: '#181818', paddingHorizontal: 16, paddingVertical: 16, marginTop: 8 },
  modalEventTitle: { fontSize: 15, fontFamily: 'Inter-Medium', color: '#181818' },
  modalEventSubtitle: { fontSize: 13, fontFamily: 'Inter-Regular', color: '#9B9B9B', marginTop: 4 },
  modalButtonSpacing: { marginTop: 16 },
  primaryButton: { backgroundColor: '#181818', paddingVertical: 14, alignItems: 'center' },
  primaryButtonText: { fontSize: 14, fontFamily: 'Inter-Medium', color: '#fff' },
  modalOutlineButton: { borderWidth: 1, borderColor: '#181818', paddingVertical: 14, alignItems: 'center', marginTop: 12 },
  ...
  vpnWarning: { fontSize: 12, lineHeight: 17, fontFamily: 'Inter-Regular', color: '#9B9B9B', marginTop: 12, marginBottom: 8 },
  verificationNote: { fontSize: 13, lineHeight: 18, fontFamily: 'Inter-Regular', color: '#181818', marginBottom: 4 },
  legalText: { marginTop: 12, fontSize: 11, lineHeight: 16, fontFamily: 'Inter-Regular', color: '#9B9B9B', textAlign: 'center' },
});
