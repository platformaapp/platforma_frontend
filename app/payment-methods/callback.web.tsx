...
const styles = StyleSheet.create({
  ...
  text: { fontSize: 16, lineHeight: 24, fontFamily: 'Inter-Regular', color: '#181818', textAlign: 'center', marginBottom: 16, maxWidth: 420 },
  hint: { fontSize: 13, lineHeight: 18, fontFamily: 'Inter-Regular', color: '#9B9B9B', textAlign: 'center' },
  button: { marginTop: 4, backgroundColor: '#181818', paddingVertical: 14, paddingHorizontal: 24, alignItems: 'center' },
