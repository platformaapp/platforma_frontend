  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.mainTitle}>ПОЛИТИКА КОНФИДЕНЦИАЛЬНОСТИ</Text>
        ...
        <Section heading="1. Общие положения">
          <P>
            ...
            персональных данных пользователей платформы p34 Якуниным Владиславом Александровичем (самозанятый,
        ...
        <Section heading="5. Передача данных третьим лицам">
          <P>
            5.1. Оператор не передаёт персональные данные третьим лицам, за исключением случаев, необходимых
            для оказания услуг:
          </P>
          <Bullet>ЮKassa (ООО «ЮMoney») — для проведения платёжных операций;</Bullet>
          <Bullet>наставникам и организаторам — в объёме, необходимом для проведения мероприятия (имя, email);</Bullet>
          <Bullet>государственным органам — по требованию, предусмотренному законодательством.</Bullet>
          <P>
            5.2. Персональные данные не продаются и не передаются в рекламных целях.
          </P>
        </Section>
