...
const styles = StyleSheet.create({
  ...
  mainTitle: { fontSize: 22, lineHeight: 30, fontFamily: 'Gramatika-Regular', fontWeight: 'normal', color: '#181818', marginTop: 4, marginBottom: 4 },
  subtitle: { fontSize: 13, lineHeight: 18, fontFamily: 'Gramatika-Regular', color: '#555', marginBottom: 24 },
  section: { marginBottom: 24 },
  sectionHeading: { fontSize: 15, lineHeight: 22, fontFamily: 'Gramatika-Regular', fontWeight: 'normal', color: '#181818', borderBottomWidth: 1, borderColor: '#1E1E1E', paddingBottom: 6, marginBottom: 10 },
  ...
  rowLabel: { fontSize: 13, lineHeight: 20, fontFamily: 'Gramatika-Regular', color: '#555', minWidth: 80, marginRight: 6 },
